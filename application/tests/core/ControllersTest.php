...
class ControllersTest extends CITestCase {
    ...
    public function testLoadController() {
        ...
        if (!is_writable($folder . '/Stub.php')) {
            // create stub file
            $success = file_put_contents($folder . '/Stub.php', '<?php class Stub extends CI_Controller { public function index(){} } ?>');
            if (!$success) {
    ...
    public function testLoadController_2() {
    ...
    public function testLoadControllerFromSubfolder() {
        ...
        if (!is_writable($folder . '/SubStub.php')) {
            // create stub file
            $success = file_put_contents($folder . '/SubStub.php', '<?php class SubStub extends CI_Controller { public function index(){} } ?>');
            if (!$success) {
    ...
    public function testLoadModel() {
        ...
        if (!is_writable($folder . '/Stubmodel.php')) {
            // create stub file
            $success = file_put_contents($folder . '/Stubmodel.php', '<?php class Stubmodel extends CI_Model { public function check(){ return true; } } ?>');
            if (!$success) {
