...
class ControllersTest extends CITestCase
{
	 ...
	 */
	public function tesstLoadController()
	{
	 ...
	 * to create folder and file.
	 */
	public function tesstLoadControllerFromSubfolder()
	{
		...
		$this->requireController('Stub');
		$filepath = APPPATH.'controllers\testsubfolder\Stub.php';
	 ...
	 */
	public function tesstLoadInexistentController()
	{
	 ...
	 * to create folder and file.
	 */
	public function tesstLoadModel()
	{
