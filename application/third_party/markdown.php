...
class Markdown implements MarkdownInterface {
    ...
    protected function stripLinkDefinitions($text) {
        ...
        $text = preg_replace_callback('{
							...
							(?:\n+|\Z)
			}xm', [$this, '_stripLinkDefinitions_callback'], $text);
    ...
    protected function hashHTMLBlocks($text) {
        ...
        $text = preg_replace_callback('{(?>
			...
			)}Sxmi', [$this, '_hashHTMLBlocks_callback'], $text);
    ...
    protected function doAnchors($text) {
        ...
        $text = preg_replace_callback('{
			...
			}xs', [$this, '_doAnchors_reference_callback'], $text);
        ...
        $text = preg_replace_callback('{
			...
			}xs', [$this, '_doAnchors_inline_callback'], $text);
    ...
    protected function doImages($text) {
        ...
        $text = preg_replace_callback('{
			...
			}xs', [$this, '_doImages_reference_callback'], $text);
        ...
        $text = preg_replace_callback('{
			...
			}xs', [$this, '_doImages_inline_callback'], $text);
        ...
        foreach ($markers_relist as $marker_re => $other_marker_re) {
            ...
            if ($this->list_level) {
                $text = preg_replace_callback('{
						^
						' . $whole_list_re . '
					}mx', [$this, '_doLists_callback'], $text);
            } else {
                $text = preg_replace_callback('{
    ...
    protected function processListItems($list_str, $marker_any_re) {
        ...
        $list_str = preg_replace_callback('{
			...
			(?= \n* (\z | \2 (' . $marker_any_re . ') (?:[ ]+|(?=\n))))
			}xm', [$this, '_processListItems_callback'], $list_str);
    ...
    protected function doCodeBlocks($text) {
        ...
        $text = preg_replace_callback('{
			...
			}xm', [$this, '_doCodeBlocks_callback'], $text);
    ...
    protected function doBlockQuotes($text) {
        $text = preg_replace_callback('/
			...
			/xm', [$this, '_doBlockQuotes_callback'], $text);
    ...
    protected function doAutoLinks($text) {
        ...
        $text = preg_replace_callback('{
			...
			>
			}xi', [$this, '_doAutoLinks_email_callback'], $text);
    ...
    protected function detab($text) {
        ...
        $text = preg_replace_callback('/^.*\t.*$/m', [$this, '_detab_callback'], $text);
