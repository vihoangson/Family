...
<p><a href="/admin/files_controller/do_upload" class="btn btn-primary"><i class="fa fa-plus"></i> Thêm media</a>
    <button type='button' onclick='$(".hide_box").toggle()'><i class='fa fa-eye'></i></button>
</p>
            ...
            <div class="col-md-2">
                ...
                <div>
                    <div class='image-link' >
                        <a class='thumbnail ' target='_blank' href='" . $value->full_img . "'>
                            <img src='" . $value->thumb_img . "' onError='" . $value->files_path_url . $value->files_name . "'>
                        </a>
                    </div>
