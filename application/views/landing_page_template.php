<?php define("PATH_T", "/asset/template/crew/") ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="<?=PATH_T;?>css/animate.css">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="<?=PATH_T;?>css/icomoon.css">
    <!-- Simple Line Icons -->
    <link rel="stylesheet" href="<?=PATH_T;?>css/simple-line-icons.css">
    <!-- Owl Carousel -->
    <link rel="stylesheet" href="<?=PATH_T;?>css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?=PATH_T;?>css/owl.theme.default.min.css">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="<?=PATH_T;?>css/bootstrap.css">
    <!--
    Default Theme Style
    ...
    7. green.css
    -->
    <link rel="stylesheet" href="<?=PATH_T;?>css/style.css">
    <!-- Styleswitcher ( This style is for demo purposes only, you may delete this anytime. ) -->
    <link rel="stylesheet" id="theme-switch" href="<?=PATH_T;?>css/style.css">
    ...
    <!-- End demo purposes only -->
    <!-- Modernizr JS -->
    <script src="<?=PATH_T;?>js/modernizr-2.6.2.min.js"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    <script src="<?= PATH_T; ?>js/respond.min.js"></script>
    <![endif]-->
</head>
<body>
        ...
        <nav class="navbar navbar-default">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="#" data-nav-section="home"><span>Trang chủ</span></a></li>
                    <li><a href="#" data-nav-section="about"><span>Giới thiệu</span></a></li>
                    <li><a href="#" data-nav-section="services"><span>Dịch vụ</span></a></li>
                    <li><a href="#" data-nav-section="features"><span>Tính năng</span></a></li>
                    ...
                    <div class="col-md-7 col-sm-7">
                        <div class="fh5co-owl-text-wrap">
                            <div class="fh5co-owl-text">
                                ...
                                <h2 class="fh5co-sub-lead to-animate">100% Free Fully Responsive HTML5 Bootstrap Template. Crafted with love by the fine folks at
                                    <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a></h3>
                                    <p class="to-animate-2">
                                        <a href="#" class="btn btn-primary btn-lg">View Case Study</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-md-push-1 col-sm-4 col-sm-push-1 iphone-image">
                        <div class="iphone to-animate-2">
                            <img src="<?=PATH_T;?>images/iphone-2.png" alt="Free HTML5 Template by FREEHTML5.co"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container" style="position: relative;">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-pull-7 col-sm-4 col-sm-pull-7 iphone-image">
                        <div class="iphone to-animate-2">
                            <img src="<?=PATH_T;?>images/iphone-1.png" alt="Free HTML5 Template by FREEHTML5.co"></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="fh5co-owl-text-wrap">
                            <div class="fh5co-owl-text">
                                ...
                                <h2 class="fh5co-sub-lead to-animate">100% Free Fully Responsive HTML5 Bootstrap Template. Crafted with love by the fine folks at
                                    <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a></h3>
                                    <p class="to-animate-2">
                                        <a href="http://freehtml5.co/" target="_blank" class="btn btn-primary btn-lg">Download This Template</a>
                                    </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row row-bottom-padded-lg" id="about-us">
            ...
            <div class="col-md-8 to-animate">
                <img src="<?=PATH_T;?>images/img_1.jpg" class="img-responsive img-rounded" alt="Free HTML5 Template">
            </div>
            ...
            <div class="col-md-12">
                <div class="row row-bottom-padded-lg">
                    <div class="col-md-4 text-center to-animate">
                        <div class="person">
                            <img src="<?=PATH_T;?>images/person2.jpg" class="img-responsive img-rounded" alt="Person">
                    ...
                    <div class="col-md-4 text-center to-animate">
                        <div class="person">
                            <img src="<?=PATH_T;?>images/person3.jpg" class="img-responsive img-rounded" alt="Person">
                    ...
                    <div class="col-md-4 text-center to-animate">
                        <div class="person">
                            <img src="<?=PATH_T;?>images/person4.jpg" class="img-responsive img-rounded" alt="Person">
                            <h3 class="name">John Doe</h3>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box-testimony to-animate">
                    ...
                    <p class="author">John Doe, CEO <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a>
                        <span class="subtext">Creative Director</span></p>
                </div>
            ...
            <div class="col-md-4">
                <div class="box-testimony to-animate">
                    ...
                    <p class="author">John Doe, Founder <a href="#">FREEHTML5.co</a>
                        <span class="subtext">Creative Director</span></p>
                </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="price-box to-animate">
                    ...
                    <div class="price"><sup class="currency">$</sup>7
                        <small>/mo</small>
                    </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="price-box to-animate">
                    ...
                    <div class="price"><sup class="currency">$</sup>19
                        <small>/mo</small>
                    </div>
                    <p>Basic customer support for small business</p>
                    <hr>
            ...
            <div class="col-md-3 col-sm-6 to-animate">
                <div class="price-box popular">
                    ...
                    <div class="price"><sup class="currency">$</sup>79
                        <small>/mo</small>
                    </div>
                    <p>Basic customer support for small business</p>
                    <hr>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="price-box to-animate">
                    ...
                    <div class="price"><sup class="currency">$</sup>125
                        <small>/mo</small>
                    </div>
                    <p>Basic customer support for small business</p>
                    <hr>
...
<footer id="footer" role="contentinfo">
    <div class="container">
        <div class="row row-bottom-padded-sm">
            <div class="col-md-12">
                <p class="copyright text-center">&copy; 2015 Free <a href="index.html">Crew</a>. All Rights Reserved.
                    <br> Free HTML5 Template by
...
<div id="colour-variations" style="display:none;">
...
<!-- jQuery -->
<script src="<?=PATH_T;?>js/jquery.min.js"></script>
<!-- jQuery Easing -->
<script src="<?=PATH_T;?>js/jquery.easing.1.3.js"></script>
<!-- Bootstrap -->
<script src="<?=PATH_T;?>js/bootstrap.min.js"></script>
<!-- Waypoints -->
<script src="<?=PATH_T;?>js/jquery.waypoints.min.js"></script>
<!-- Owl Carousel -->
<script src="<?=PATH_T;?>js/owl.carousel.min.js"></script>
<!-- For demo purposes only styleswitcher ( You may delete this anytime ) -->
<script src="<?=PATH_T;?>js/jquery.style.switcher.js"></script>
<script>
    $(function () {
...
<script src="<?=PATH_T;?>js/main.js"></script>
</body>
</html>