...
<form action="" method="POST" role="form" enctype="multipart/form-data">
    ...
    if ($rs->timeline_image) {
        ...
        <a class="btn btn-default" href="/timeline/rotate_img_timeline/timeline_<?=$rs->id;?>/right">
            <i class="fa fa-rotate-left"></i> </a>
        <a class="btn btn-default" href="/timeline/rotate_img_timeline/timeline_<?=$rs->id;?>/left">
    ...
    <div class="toggle_box" style="display:none;">
        <div class="form-group">
            ...
            <input type="text" class="form-control datepicker" id="" placeholder="Input field" name="timeline_date" value="<?=($rs->timeline_date ?
                $rs->timeline_date : date("d-m-Y"));?>">
        </div>
        <div class="form-group">
            <label for="">Tag</label>
