...
<form method="post" action="">
    ...
    <p><input type="text" class="form-control" name="title" value="<?=(isset($data->blog_title) ? $data->blog_title :
            "");?>"></p>

    <?=(isset($data->id) ? "<input type='hidden' value='" . $data->id . "' name='id'>" : "");?>

    <p>
        <a class="btn btn-info" href="https://vihoangson.wordpress.com/wp-admin/media-new.php" target="_blank">Upload to Wordpress.com</a>
    </p>
